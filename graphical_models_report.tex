...
\begin{equation}
\begin{aligned}
- \frac{\partial p(v)}{\partial \Theta} = \frac{\partial \mathcal{F}(v)}{\partial \Theta}} -\frac{1}{|\mathcal{N}|} \sum\limits_{\tilde{v} \epsilon \matchcal{N}}p(\tilde{v}) \frac{\partial \mathcal{F}(\tilde{v})}{\partial \Theta}
\end{aligned}
\end{equation}
...
G.~Hinton and S.~Osindero, ''A fast learning algorithm for deep belief nets,'' \emph{Neural Computation}, vol. 18, Boston, MA: Massachusetts Institute of Technology, 2006.
\bibitem{IEEEhowto:kopka}
G.~Hinton and R.~Salakhutdinov, ''An Efficient Learning Procedure for Deep Boltzmann Machines,'' \emph{Neural Computation}, vol. 24, Boston, MA: Massachusetts Institute of Technology, 2012.
\bibitem{IEEEhowto:kopka}
Theano Development, "Restricted Boltzmann Machines (RBM)." \emph{Theano Development} Documentation. Accessed December 4, 2014. http://deeplearning.net/tutorial/rbm.html.
